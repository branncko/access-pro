...
function accesspress_mag_setup() {
    ...
    add_image_size( 'accesspress-mag-slider-roraima', 592, 385, true); //Slider do site
    ...
    add_image_size( 'accesspress-mag-block-small-thumb', 540, 360, true ); //Small thumb for homepage block
...
function accesspress_mag_scripts() {
    ...
    if ( of_get_option( 'news_ticker_option', '1' ) == 1 ) {
    	wp_enqueue_style( 'accesspress-mag-ticker', get_template_directory_uri() . '/js/news-ticker/ticker-style.css' );
    	wp_enqueue_script( 'accesspress-mag-news-ticker', get_template_directory_uri() . '/js/news-ticker/jquery.ticker.js', array('jquery'), '2.0.0', true );
    }
    ...
    if( $apmag_ligtbox_option == '1' ) {
        wp_enqueue_style( 'accesspress-mag-nivolightbox-style', get_template_directory_uri(). '/js/lightbox/nivo-lightbox.css', array( 'accesspress-mag-style' ), '1.2.0' );
 ...
 */
require get_template_directory() . '/woocommerce/apwoo-functions.php';
