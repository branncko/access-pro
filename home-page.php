        ...
        <section class="slider-wrapper">
            <div class="apmag-container"> 
                <?php  
                    ...
                    } elseif( !empty( $apmag_slider_option ) && $apmag_slider_option == 'slider-rev' && !empty( $rev_slider_shortcode ) ) {
                        echo do_shortcode( $rev_slider_shortcode );
                    } elseif( !empty( $apmag_slider_option ) && $apmag_slider_option == 'slider_highlight' ) {
                        do_action( 'accesspress_mag_slider_highlighted' );
                    } else {
