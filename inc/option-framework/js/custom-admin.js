...
//Display option for video section in meta box
  ...
  $('#slider_effect_option').on('change',function(){
    if( $(this).is(':checked') ) {
        $('#section-slider_pager, #section-slider_controls, #section-slider_auto_transition, #section-slider_transition, #section-slider_speed, #section-slider_pause, #section-count_slides, #section-slider_title_bg_color, #section-slider_layout, #section-apmag_rev_slider_shortcode, #section-slider_highlight_category').hide();
    } else {
        $('#section-slider_pager, #section-slider_controls, #section-slider_auto_transition, #section-slider_transition, #section-slider_speed, #section-slider_pause, #section-count_slides, #section-slider_title_bg_color, #section-slider_layout, #section-apmag_rev_slider_shortcode, #section-slider_highlight_category').show();
    }
  }).change();
 ...
 */
 ...
 imgRadio = $('#homepage_layouts_settings').find('.of-radio-img-radio:checked').val();
 if( imgRadio == 'home-default' ) {
      $('.help-icon').attr('data-style','homestyle_1');
 } else {
      $('.help-icon').attr('data-style','homestyle_2');
 }

$('#section-homepage_layout').find('img').on('click',function(){
   imgRadio = $('#homepage_layouts_settings').find('.of-radio-img-radio:checked').val();
   //imgRadio = $(this).parent('.of-radio-img-radio:checked').val();
   if( imgRadio == 'home-default' ) {
        $('.help-icon').attr('data-style','homestyle_1');
   } else {
        $('.help-icon').attr('data-style','homestyle_2');
 ...
 /*var imgRadio = $('#homepage_layouts_settings').find('of-radio-img-radio:checked').val()
 alert(imgRadio);*/

 //block section layout image on hover effect
  $('.help-icon').click(function(){
      var imgId = $(this).attr('id');
      var imgStyle = $(this).attr('data-style');
      //alert(imgStyle);
      $(this).next('.'+imgStyle).slideToggle();
  });
});
