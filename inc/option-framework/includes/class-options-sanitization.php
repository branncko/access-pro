 ...
 * @return $output sanitized string
 */
function of_sanitize_apmagtextarea( $input ) {
	//global $allowedposttags;
	$output =  $input ;
	return $output;
}
add_filter( 'of_sanitize_apmagtextarea', 'of_sanitize_apmagtextarea' );
...
$accesspress_pro_font_list = get_option('accesspress_mag_google_font');
    foreach ($accesspress_pro_font_list as $font_name) {
...
function of_recognized_font_styles() {
	$default = array(
        '100' => __('Thin', 'accesspress-mag'),
        '200' => __('Extra Light', 'accesspress-mag'),
        '300' => __('Light', 'accesspress-mag'),
        '400' => __('Normal', 'accesspress-mag'),
        '500' => __('Medium', 'accesspress-mag'),
        '600' => __('Semi Bold', 'accesspress-mag'),
        '700' => __('Bold', 'accesspress-mag'),
        '800' => __('Extra Bold', 'accesspress-mag'),
        '900' => __('Ultra Bold', 'accesspress-mag'),
        '100italic' => __('Thin Italic', 'accesspress-mag'),
        '300italic' => __('Light Italic', 'accesspress-mag'),
        '400italic' => __('Normal Italic', 'accesspress-mag'),
        '500italic' => __('Medium Italic', 'accesspress-mag'),
        '600italic' => __('Semi Bold Italic', 'accesspress-mag'),
        '700italic' => __('Bold Italic', 'accesspress-mag'),
        '800italic' => __('Extra Bold Italic', 'accesspress-mag'),
        '900italic' => __('Ultra Bold Italic', 'accesspress-mag'),
    );
