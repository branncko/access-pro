...
//				}
            ...
            case 'apmagtextarea':
				...
				//$val = stripslashes( $val );
				$output .= '<textarea id="' . esc_attr( $value['id'] ) . '" class="of-input" name="' . esc_attr( $option_name . '[' . $value['id'] . ']' ) . '" rows="' . $rows . '"' . $placeholder . '>' . $val . '</textarea>';
				break;
			...
			case 'select':
				...
				$output .= '</select>';
				if( isset( $value['help_img'] ) && !empty( $value['help_img'] ) ) {
					$output .= '<div class="help-icon" id="'.$value['id'].'"><span><i class="fa fa-question-circle"></i></span></div>';
					$output .= '<div class="help-img-show homestyle_1" id="helpimg-'.$value['id'].'" style="display:none;"><span class="help-img-label">'. __( 'Block Layout', 'accesspress-mag' ) .'</span><img src="'. esc_url( $value['help_img'] ) .'" /></div>';
				}
				if( isset( $value['help_img_2'] ) && !empty( $value['help_img_2'] ) ) {
					$output .= '<div class="help-img-show homestyle_2" id="helpimg-'.$value['id'].'" style="display:none;"><span class="help-img-label">'. __( 'Block Layout', 'accesspress-mag' ) .'</span><img src="'. esc_url( $value['help_img_2'] ) .'" /></div>';
				}
				break;
