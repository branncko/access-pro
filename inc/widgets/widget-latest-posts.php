...
function register_latest_posts_widget() {
    register_widget( 'apmag_register_latest_posts' );
}

if( !class_exists( 'Apmag_Register_Latest_Posts' ) ):
class Apmag_Register_Latest_Posts extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'apmag_register_latest_posts', 'AP-Mag : Latest Posts', array(
