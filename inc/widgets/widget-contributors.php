...
add_action( 'widgets_init', 'apmag_article_contributors_widget' );

function apmag_article_contributors_widget() {
    register_widget( 'apmag_article_contributors' );
}

if( !class_exists( 'Apmag_Article_Contributors' ) ) :
class Apmag_Article_Contributors extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'apmag_article_contributors', 'AP-Mag :  Article Contributors', array(
    ...
    ?>
        <div class="contributors-wrapper clearfix">
            ...
            <div class="single-user-wrapper">
                ...
                ?>
                            <div class="single-user" id="user-<?php echo $user_id ; ?>">
                                <a href="<?php echo esc_url( get_author_posts_url( $user_id, $user_nickname ) ) ;?>" title="<?php echo esc_attr( $user_name );?>">
