...
<div class="my_post_settings">
        <table class="form-table">
            <tr><th colspan="2"><em class="f13"><?php _e( 'Post template:', 'accesspress-mag' )?></em></th></tr>            
            <tr><td>
            <?php  
        ...
        <table class="form-table">
            <tr><th colspan="2"><em class="f13"><?php _e( 'Post Sidebar', 'accesspress-mag' ); ?></em></th></tr>
            <tr><td>
            <?php  
            ...
            <tr><td><em class="f13"><?php _e( 'You can set up the sidebar content', 'accesspress-mag' );?> <a href="<?php echo admin_url('/themes.php?page=options-framework'); ?>"><?php _e( 'here', 'accesspress-mag' );?></a></em></td></tr>
        </table>
