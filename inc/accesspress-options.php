...
/*-----------------------Homepage Settings------------------------*/
   ...
   /*-------------Slider Settings Tab ----------------*/
    ...
    $options[] = array(
            ...
            'id' => 'featured_block_1',
            'type' => 'select',
            'help_img' => $imagepath.'block_layout/layout1.png',
            'help_img_2' => $imagepath.'block_layout/layout2.png',
            'options' => $options_categories
            );
    $options[] = array(
            'name' => __( 'Number of posts', 'accesspress-mag' ),
    ...
    $options[] = array(
            ...
            'id' => 'featured_block_2',
            'type' => 'select',
            'help_img' => $imagepath.'block_layout/layout3.png',
            'help_img_2' => $imagepath.'block_layout/layout5.png',
            'options' => $options_categories
            );
    $options[] = array(
            'name' => __( 'Number of posts', 'accesspress-mag' ),
    ...
    $options[] = array(
            ...
            'type' => 'select',
            'help_img' => $imagepath.'block_layout/layout1.png',
            'help_img_2' => $imagepath.'block_layout/layout3.png',
            'options' => $options_categories
            );
    $options[] = array(
            'name' => __( 'Number of posts', 'accesspress-mag' ),
    ...
    $options[] = array(
            ...
            'id' => 'featured_block_4',
            'type' => 'select',
            'help_img' => $imagepath.'block_layout/layout4.png',
            'help_img_2' => $imagepath.'block_layout/layout6.png',
            'options' => $options_categories
            );
    $options[] = array(
            'name' => __( 'Number of posts', 'accesspress-mag' ),
    ...
    /*------------------------Homepage Additional Settings------------------------*/
    $options[] = array(
            'name' => __( 'Additional Settings', 'accesspress-mag' ),
            'id'   => 'homepage_additional_settings',
            'type' => 'groupstart'
            );
    $options[] = array(
            'name' => __( 'Show Author', 'accesspress-mag' ),                
            'desc' => __( 'Enable or disable the post author at homepage.', 'accesspress-mag' ),
            'id' => 'home_author_option',
            'on' => __( 'Yes', 'accesspress-mag' ),
            'off' => __( 'No', 'accesspress-mag' ),
            'std' => '1',
            'type' => 'switch'
    ...
    $options[] = array(
            'name' => __( 'Author Type', 'accesspress-mag' ),
            'desc' => __( 'Define - type of posts author', 'accesspress-mag' ),
            'id' => 'home_author_type',            
            'options' => array(
                    'plain_text' => __( 'Plain Text', 'accesspress-mag' ),
                    'box_text'   => __( 'Text with box', 'accesspress-mag' ),
                    ),
            'type' => 'radio',
            'std' => 'plain_text' 
            );
