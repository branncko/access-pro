...
<div class="apmag-container">
     <?php   
        $trans_search_result = of_get_option( 'trans_search_results_for' );
        if( empty( $trans_search_result ) ) {
        	$trans_search_result = 'Search Results for';
        }
	...
	<section id="primary" class="content-area">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title"><span><?php printf( __( $trans_search_results_for.' : %s', 'accesspress-mag' ), '</span><span>' . get_search_query() . '</span>' ); ?></h1>
			</header><!-- .page-header -->
