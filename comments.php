...
$trans_old = of_get_option( 'trans_older_comments', __( 'Older Comments', 'accesspress-mag' ) );
if( empty( $trans_old ) ) { $trans_old = __( 'Older Comments', 'accesspress-mag' ); }
$trans_new = of_get_option( 'trans_newer_comments', __( 'Newer Comments', 'accesspress-mag' ) );
if( empty( $trans_new ) ) { $trans_new = __( 'Newer Comments', 'accesspress-mag' ); }
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			...
			<div class="nav-links">
				...
				<div class="nav-previous"><?php previous_comments_link( $trans_old ); ?></div>
				<div class="nav-next"><?php next_comments_link( $trans_new ); ?></div>
